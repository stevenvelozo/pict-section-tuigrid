      ...
      var PictSectionTuiGrid = /*#__PURE__*/function (_libPictViewClass) {
        ...
        _createClass(PictSectionTuiGrid, [{
          ...
          value: function postInitialRenderInitialize() {
            ...
            var tmpTargetElement = this.defaultServices.ContentAssignment.getElement(this.options.TargetElementAddress);

            // Setup the solver
            for (var i = 0; i < this.options.TuiColumnSchema.length; i++) {
              var tmpColumn = this.options.TuiColumnSchema[i];
